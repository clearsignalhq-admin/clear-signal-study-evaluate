        ...
        <div className="flex justify-content-center pb-8">
            <div className="w-full md:w-10 lg:w-8">
                <div className="flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 className="text-3xl font-bold m-0 text-900">{subjectName} Progress</h1>
                        <p className="text-600 m-0">Performance analytics over time</p>
                    </div>
                    <Link to="/report-card">
                        <Button label="Back to Report Card" icon="pi pi-arrow-left" text className="font-bold"/>
                    </Link>
                </div>
                    ...
                    <div className="col-12 md:col-6">
                        <Card className="shadow-2 border-round-xl h-full">
                            <div className="flex flex-column align-items-center justify-content-center text-center">
                                <span className="text-600 font-medium mb-2">Cumulative Average</span>
                                <span className={`text-5xl font-bold ${getScoreColor(averageScore)}`}>
                                    {averageScore.toFixed(1)}%
                                </span>
                                <span className="text-500 text-sm mt-2">Weighted by number of questions</span>
                            </div>
                        </Card>
                    </div>
                    <div className="col-12 md:col-6">
                        <Card className="shadow-2 border-round-xl h-full">
                             <div className="flex flex-column align-items-center justify-content-center text-center">
                                <span className="text-600 font-medium mb-2">Total Exams Taken</span>
                                <span className="text-5xl font-bold text-900">
                                    {totalAttempts}
                                </span>
                                <span className="text-500 text-sm mt-2">Sessions completed</span>
                            </div>
                        </Card>
                    </div>
                </div>
                ...
                <Card className="shadow-2 border-round-xl">
                    <h2 className="text-xl font-bold text-900 mb-4">Performance Trend</h2>
                    {totalAttempts > 0 ? (
